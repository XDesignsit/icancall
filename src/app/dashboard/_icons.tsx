...
/* Single-path icon set. `Icon` supplies the shared svg chrome. */
...
export function Icon({ name, className, ...rest }: { name: keyof typeof ICONS; className?: string } & React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
