...
const STRINGS: Record<string, PlanChangeStrings> = {
  en: {
    ...
    noChargeNow: "No charge today. Any unused balance is credited toward your next invoice.",
  ...
  es: {
    ...
    noChargeNow: "Sin cargo hoy. El saldo no utilizado se abonará en su próxima factura.",
  ...
  fr: {
    ...
    noChargeNow: "Aucun débit aujourd'hui. Le solde non utilisé sera crédité sur votre prochaine facture.",
  ...
  ja: {
    ...
    noChargeNow: "本日の請求はありません。未使用分は次回の請求額から差し引かれます。",
  ...
  zh: {
    ...
    noChargeNow: "今天不会扣款。未使用的余额将抵扣您的下一张账单。",
  ...
  ar: {
    ...
    noChargeNow: "لا توجد رسوم اليوم. سيُضاف الرصيد غير المستخدم إلى فاتورتك القادمة.",
  ...
  hi: {
    ...
    noChargeNow: "आज कोई शुल्क नहीं। अप्रयुक्त शेष राशि आपके अगले बिल में समायोजित की जाएगी।",
  ...
  pt: {
    ...
    noChargeNow: "Nenhuma cobrança hoje. O saldo não utilizado será creditado na sua próxima fatura.",
  ...
  de: {
    ...
    noChargeNow: "Heute erfolgt keine Belastung. Nicht genutztes Guthaben wird Ihrer nächsten Rechnung gutgeschrieben.",
  ...
  it: {
    ...
    noChargeNow: "Nessun addebito oggi. Il saldo non utilizzato verrà accreditato sulla prossima fattura.",
  ...
  ko: {
    ...
    noChargeNow: "오늘은 청구되지 않습니다. 사용하지 않은 잔액은 다음 청구서에서 차감됩니다.",
