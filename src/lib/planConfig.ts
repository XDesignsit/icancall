...
const PLAN_RANK: Record<PlanId, number> = { essential: 0, pro: 1, careteam: 2 };
 ...
 * immediately; moving down takes no payment and gives no refund — the plan
 * changes now and the lower price starts at the next billing date.
 */
