...
const STRINGS: Record<string, PlanChangeStrings> = {
  en: {
    ...
    noChargeNow: "No charge today. Your plan changes immediately, and your new price will apply on your next billing date.",
  ...
  es: {
    ...
    noChargeNow: "Sin cargo hoy. Su plan cambia de inmediato y su nuevo precio se aplicará en su próxima fecha de facturación.",
  ...
  fr: {
    ...
    noChargeNow: "Aucun débit aujourd'hui. Votre forfait change immédiatement et votre nouveau tarif s'appliquera à votre prochaine date de facturation.",
  ...
  ja: {
    ...
    noChargeNow: "本日の請求はありません。プランはすぐに変更され、次回の請求日より新しい料金が適用されます。",
  ...
  zh: {
    ...
    noChargeNow: "今天不会扣款。您的方案将立即生效，新的价格将在下一个计费日开始应用。",
  ...
  ar: {
    ...
    noChargeNow: "لا توجد رسوم اليوم. تتغير باقتك فوراً، وسيطبق السعر الجديد في موعد الفوترة التالي.",
  ...
  hi: {
    ...
    noChargeNow: "आज कोई शुल्क नहीं। आपका प्लान तुरंत बदल जाएगा, और अगली बिलिंग तिथि से नई कीमत लागू होगी।",
  ...
  pt: {
    ...
    noChargeNow: "Nenhuma cobrança hoje. O seu plano muda imediatamente e o novo valor será cobrado na próxima data de faturação.",
  ...
  de: {
    ...
    noChargeNow: "Heute erfolgt keine Belastung. Ihr Tarif ändert sich sofort und der neue Preis gilt ab Ihrem nächsten Abrechnungsdatum.",
  ...
  it: {
    ...
    noChargeNow: "Nessun addebito oggi. Il tuo piano cambia immediatamente e la nuova tariffa verrà applicata alla prossima data di fatturazione.",
  ...
  ko: {
    ...
    noChargeNow: "오늘은 청구되지 않습니다. 플랜은 즉시 변경되며, 다음 결제일부터 새로운 요금이 적용됩니다.",
